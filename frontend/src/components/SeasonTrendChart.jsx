...
export default function SeasonTrendChart({ data }) {
  return (
    <div className="card">
      <h3 className="card-title">📈 Season Trend — Virat Average vs RCB Win Rate</h3>
      <p className="card-sub">How Virat's performance across seasons correlates with RCB's success</p>
